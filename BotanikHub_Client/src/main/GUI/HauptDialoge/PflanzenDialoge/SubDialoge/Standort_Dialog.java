...
public class Standort_Dialog extends Dialog<ButtonType> {

	public Standort_Dialog(PflanzeFX p) {
		...
		// Headerbild
		ImageView header = new ImageView(new Image(BotanikHub_Client.class.getResource("/Standort_Dialog_Headerbild.jpg").toString()));
