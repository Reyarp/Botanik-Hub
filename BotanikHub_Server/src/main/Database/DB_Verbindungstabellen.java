...
public class DB_Verbindungstabellen {
	...
	public static void createPflanzenTyp() throws SQLException{
		...
		try {
			...
			// SQL create: Erstellt Verbindungstabelle zwischen Pflanze und Pflanzentyp (n:m)
			// Enthält zusammengesetzten Primärschlüssel (PFLANZE_ID, PFLANZEN_TYPEN)
	...
	public static void createVermehrung() throws SQLException{
		...
		try {
			...
			// SQL create: Erstellt Verbindungstabelle zwischen Pflanze und Vermehrungsart (n:m)
			// Enthält zusammengesetzten Primärschlüssel (PFLANZE_ID, VERMEHRUNG_ARTEN)
			String create = "CREATE TABLE " +
	...
	public static void createVerwendeteTeile() throws SQLException{
		...
		try {
			...
			// SQL create: Erstellt Verbindungstabelle zwischen Pflanze und verwendeten Pflanzenteilen (n:m)
			// Enthält zusammengesetzten Primärschlüssel (PFLANZE_ID, VERWENDETE_TEILE)
			String create = "CREATE TABLE " +
